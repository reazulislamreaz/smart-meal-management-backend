...
describe('AdminService', () => {
  ...
  const mockPrismaService = {
    ...
    subscription: {
      ...
      findMany: jest.fn().mockResolvedValue([]),
      findUnique: jest.fn().mockResolvedValue({ id: 'sub-1', planName: 'Monthly Premium' }),
      create: jest.fn().mockResolvedValue({ id: 'sub-1', planName: 'Annual Plan' }),
      update: jest.fn().mockResolvedValue({ id: 'sub-1', status: 'ACTIVE' }),
      groupBy: jest.fn().mockResolvedValue([{ planName: 'Monthly Premium', _count: { id: 15 } }]),
    },
    subscriptionPlan: {
      count: jest.fn().mockResolvedValue(2),
      findMany: jest.fn().mockResolvedValue([
        { id: 'plan-1', name: 'Monthly Premium', price: 7.99, isActive: true },
      ]),
      findUnique: jest.fn().mockResolvedValue({ id: 'plan-1', name: 'Monthly Premium', price: 7.99 }),
      create: jest.fn().mockResolvedValue({ id: 'plan-2', name: 'Family Tier', price: 14.99 }),
    ...
    meal: {
      ...
      findMany: jest.fn().mockResolvedValue([]),
      findUnique: jest.fn().mockResolvedValue({ id: 'meal-1', title: 'Chicken Salad' }),
      create: jest.fn().mockResolvedValue({ id: 'meal-2', title: 'Salmon Bowl' }),
      update: jest.fn().mockResolvedValue({ id: 'meal-1', title: 'Updated Chicken Salad' }),
      delete: jest.fn().mockResolvedValue({ id: 'meal-1' }),
    },
    coupon: {
      count: jest.fn().mockResolvedValue(5),
      findMany: jest.fn().mockResolvedValue([]),
      findUnique: jest.fn().mockResolvedValue({ id: 'coup-1', code: 'SAVE20', redemptions: [] }),
      create: jest.fn().mockResolvedValue({ id: 'coup-2', code: 'SAVE30', discountPercent: 30 }),
      update: jest.fn().mockResolvedValue({ id: 'coup-1', discountPercent: 25 }),
    ...
    contactMessage: {
      ...
      findMany: jest.fn().mockResolvedValue([]),
      findUnique: jest.fn().mockResolvedValue({ id: 'msg-1', name: 'John Doe', status: 'UNREAD' }),
  ...
  it('should create a subscription plan', async () => {
    (prisma.subscriptionPlan.findUnique as jest.Mock).mockResolvedValueOnce(null);
  ...
  it('should assign a subscription to a user', async () => {
    (prisma.user.findUnique as jest.Mock).mockResolvedValueOnce({ id: 'user-1', email: 'user@example.com' });
